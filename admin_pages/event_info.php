...
<body class="grid_wrap">
    ...
    <section class="social">
        <!-- <div class="add_event"> -->
            <a class="add_google" href="https://www.google.com/calendar/render?action=TEMPLATE&text=<?php echo $event_name; ?>+:+<?php echo $cat; ?>&dates=<?php echo $date; ?>T<?php echo $time_from; ?>/<?php echo $date; ?>T<?php echo $time_to; ?>&details=<?php echo $des; ?>.+For+details,+please+contact+at:+Email:+<?php echo $admin_email; ?>+Phone:+<?php echo $admin_phone; ?>+at+<?php echo $group_name; ?>&location=<?php echo $location; ?>&sf=true&output=xml" target="_blank" rel="noopener noreferrer">
        ...
        <!-- <div class="social_network"> -->
            <div class="twitter_share">
                <a class="twitter-share-button" href="https://twitter.com/intent/tweet" data-size="large" data-text="<?php echo $event_name; ?> on <?php echo $date; ?> at <?php echo $uni; ?>." data-url="https://evieventplanner.com" data-hashtags="EVI,EventPlanner">
                    Tweet
                </a>
            </div>

            <div class="fb-share-button" data-href="https://evieventplanner.com" data-layout="button" data-size="large">
                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fevieventplanner.com%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">
                    Share
                </a>
            </div>
        <!-- </div> -->
