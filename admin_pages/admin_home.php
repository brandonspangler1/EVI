...
<body>
    ...
    <section class="picture-wrap-outer">
        <div class="picture-wrap-inner" style="background-image: url('../super_admin_pages/<?=$picture_link?>'); background-repeat: no-repeat; height: 100%; width: 25%;">
        </div>
    </section>
