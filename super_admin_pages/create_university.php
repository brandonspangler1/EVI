                ...
                if (mysqli_query($con, $update_status)) {
                    ...
                    if ($result) {
                        ...
                        # University Name doesn't already exist in the database. Insert the University Information 
                            ...
                            $query = "INSERT INTO `universities`(`super_admin_id`, `name`, `location`, `num_students`, `description`, `picture_name`) VALUES ('$super_id','$name','$location','$num_students','$description', '$picture_name')";
