            ...
            <div class="describe">
                ...
                <div class="social_network">
                    <div class="twitter_share">
                        <a class="twitter-share-button" href="https://twitter.com/intent/tweet" data-size="large" data-text="<?php echo $private_name; ?> on <?php echo $private_date; ?> at <?php echo $private_university; ?>." data-url="https://evieventplanner.com" data-hashtags="EVI,EventPlanner">
                            Tweet
                        </a>
                    </div>
