...
<head>
    ...
    <link rel="stylesheet" href="css/rso_event_information.css" />
</head>
            ...
            <div class="describe">
                ...
                <div class="social_network">
                    <div class="twitter_share">
                        <a class="twitter-share-button" href="https://twitter.com/intent/tweet" data-size="large" data-text="<?php echo $event_name; ?> (<?php echo $rso_name; ?>) on <?php echo $event_date; ?> at <?php echo $university; ?>." data-url="https://evieventplanner.com" data-hashtags="EVI,EventPlanner">
                            Tweet
                        </a>
                    </div>
