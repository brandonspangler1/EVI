    ...
    <div class="popup_container" id="create-account-popup">
        <div class="register_popup">
            <form style="text-align: center;" method="POST" action="account_actions.php">
                ...
                <br><br>
                <button type="submit" class="sa_register_btn" name="sa_register">
    ...
    <div class="popup_container" id="help-popup">
        <div class="help_popup">
            ...
            <div class="help_description">
                ...
                During your EVI experience, there may be some problems that may arise.
                The biggest problem is that a user cannot use the "apostrophe" or "single quote".
                The special character or punctuation (') cannot be used in the web application
                unless the user inserts a forward slash or (\) in front of the (').
                For example, if a user wants to name something (User's Page), the server will not
                accept the name unless the user uses (User\'s Page).
                Thank You
