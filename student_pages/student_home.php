...
?>
    ...
    const rendCalendar = () => {
        ...
        document.querySelector(".date p").innerHTML = "" + dayName[firstDayIndex] + " " + months[curMonth] + " " + curDate + " " + curYear;
        ...
        if (document.getElementById("today"))
            document.querySelector('.today').addEventListener('click', () => {
                document.cookie = "date = " + date.getFullYear() + getMonthFormatter + date.getMonth() + "-" + date.getDate();
                location.href = "student_day_events.php";
            })
