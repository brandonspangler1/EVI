...
<head>
    ...
    <link rel="stylesheet" href="student_public_events.css" />
</head>
...
<body>
    ...
    <div class="public">
                ...
                ?>
                            ...
                            <tr class="names">
                                <td>
                                    ...
                                    <button class="event_info" onclick="location.href = 'student_public_info.php?name=<?php echo $name['name']; ?>&university=<?php echo $name['university']; ?>'">
                                        <div class="first">
                                            <?php
                                            echo "$name[date]";
                                            ?>
        ...
        <div class="view">
            <button onclick="location.href = 'student_private_events.php'">
                View Private Events
            </button>
        </div>
    </div>
