    ...
    <div class="rso_request">
        <form method="POST">
            ...
            <div class="member_emails">
                ...
                <h3 id="rso_members">
                    <input type="text" id="member_email" name="member_email1" placeholder="Email 1" required> 
                </h3>
                <h3 id="rso_members">
                    <input type="text" id="member_email" name="member_email2" placeholder="Email 2" required> 
                </h3>
                <h3 id="rso_members">
                    <input type="text" id="member_email" name="member_email3" placeholder="Email 3" required> 
                </h3>
                <h3 id="rso_members">
                    <input type="text" id="member_email" name="member_email4" placeholder="Email 4" required> 
                </h3>
            </div>
            </div>
